  ...
  return (
      ...
      <Container>
        ...
        <ThankYouSection>
          ...
          <LinkSection>
          <CodeForSFLogoImg data-testid="CodeForSFLogo"></CodeForSFLogoImg>
          <GitHubLogoImg data-testid="GitHubLogo"></GitHubLogoImg>
          
         
          </LinkSection>

          <LinkSection>
          <ReactLogoImg data-testid="ReactLogo"></ReactLogoImg>
          </LinkSection>
        </ThankYouSection>
      </Container>
