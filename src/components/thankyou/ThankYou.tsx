  ...
  return (
    <Container>
      ...
      <ThankYouSection>
        ...
        <LogoSection>
          <a href="https://www.codeforsanfrancisco.org/" data-testid="CodeForSFLink"><CodeForSFLogoImg data-testid="CodeForSFLogo" alt="Code for SF Logo Logo" src={CodeForSFLogo}></CodeForSFLogoImg></a>
          <a href="https://github.com/" data-testid="GitHubLink"><GitHubLogoImg data-testid="GitHubLogo" alt="Git Hub Logo" src={GitHubLogo} ></GitHubLogoImg></a>
        </LogoSection>

        <LogoSection>
        <a href="https://reactjs.org/" data-testid="ReactLink"><ReactLogoImg data-testid="ReactLogo" alt="React Logo" src={ReactLogo} ></ReactLogoImg></a>
        </LogoSection>
